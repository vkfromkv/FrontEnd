...
const Lyrics = () => {
    const [song, setSong] = useState({song_key: "", capo_position: "", title: "", artist: "", tuning: "", lyrics: "", created_on: ""});
    ...
    return (
        ...
        <div className=" transpose-section">
                ...
                {transpose===0 ? <p className="transpose-value"></p> : <p className="transpose-value">{transpose}</p>
                                }
